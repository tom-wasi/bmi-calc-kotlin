...
import tomwas.pjwstk.bmi_calc_with_kotlin.fragments.RecipeRecommendationFragment
...
class CalculatorPagerAdapter(activity: FragmentActivity) : FragmentStateAdapter(activity) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            ...
            3 -> RecipeRecommendationFragment()
